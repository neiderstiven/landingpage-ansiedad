    ...
    <section id="product" className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="text-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-secondary/15 px-4 py-2 text-xs font-semibold uppercase tracking-wider text-teal-800">
            La solución
          </span>
          <h2 className="mt-5 font-serif text-3xl font-bold text-foreground md:text-4xl lg:text-5xl">
            Presentamos <span className="text-primary">"Adiós Ansiedad"</span>
          </h2>
        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div className="rounded-3xl border border-slate-100 bg-gradient-to-br from-background to-white p-8 shadow-lg md:p-10">
            <div className="flex items-baseline gap-2">
              <span className="font-serif text-4xl font-bold text-foreground md:text-5xl">$5.99</span>
            ...
            <Button
              ...
              className="mt-8 h-14 w-full rounded-full bg-primary text-base font-semibold text-white shadow-lg shadow-primary/30 transition hover:bg-primary/90 hover:shadow-xl"
        ...
        <div className="mt-20 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {benefits.map((b, i) => (
            ...
            >
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-secondary text-white shadow">
                <b.icon className="h-6 w-6" />
              </div>
              <h4 className="font-serif text-lg font-semibold text-foreground">{b.title}</h4>
